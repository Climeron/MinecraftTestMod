...
import ru.climeron.netheradditions.event.EventFactory;
import ru.climeron.netheradditions.main.Main;
import ru.climeron.netheradditions.world.biomes.data.BiomeData;

public class ChunkGeneratorNetherAdditions extends ChunkGeneratorHell
{
    ...
    public ChunkGeneratorNetherAdditions(World world, boolean generateStructures, long seed)
    {
    ...
    public void buildSurfaces(int chunkX, int chunkZ, ChunkPrimer primer)
    {
        ...
        for(int posX = 0; posX < 16; posX++)
        {
            ...
            {
                BiomeData biomeData = Main.BIOME_DATA_MANAGER.getBiomeData(world.getBiome(blockPos.add(posX, 0, posZ)));
    ...
    public Chunk generateChunk(int chunkX, int chunkZ)
    {
        ...
        BlockPos blockPos = new BlockPos(chunkX * 16, 0, chunkZ * 16);
        BiomeData biomeData = Main.BIOME_DATA_MANAGER.getBiomeData(this.world.getBiome(blockPos.add(16, 0, 16)));
        ...
        EventFactory.onChunkGenerate(chunk);
        return chunk;
    }
    ...
    public void populate(int chunkX, int chunkZ)
    {
        ...
        EventFactory.onPreDecorateBiome(this.world, this.random, chunkPos);
        EventFactory.onDecorateBiome(this.world, this.random, chunkPos, blockPos, DecorateBiomeEvent.Decorate.EventType.CUSTOM);
        ...
        EventFactory.onPostDecorateBiome(this.world, this.random, chunkPos);
        EventFactory.onPreOreGen(this.world, this.random, blockPos);
        EventFactory.onOreGen(this.world, this.random, new WorldGenMinable(Blocks.AIR.getDefaultState(), 0, BlockMatcher.forBlock(Blocks.AIR)), blockPos, OreGenEvent.GenerateMinable.EventType.CUSTOM);
        EventFactory.onPostOreGen(this.world, this.random, blockPos);
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos)
    {
        ...
        BiomeData biomeData = Main.BIOME_DATA_MANAGER.getBiomeData(biome);
